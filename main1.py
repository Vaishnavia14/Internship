...
# Load the model
model = load_model("C:/Users/vaish/PycharmProjects/FaceRecoginition_attendence/keras_model.h5", compile=False)

# Load the labels
class_names = open("C:/Users/vaish/PycharmProjects/FaceRecoginition_attendence/labels.txt", "r").readlines()
...
try:
    conn = mysql.connector.connect(
        ...
        password="kimtaehyung",  # Your MySQL password
